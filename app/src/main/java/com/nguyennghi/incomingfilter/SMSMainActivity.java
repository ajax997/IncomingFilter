...
public class SMSMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_new.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(SMSMainActivity.this, NewSmsActivity.class));
            }
        });
    ...
    public void init()
    {
        smsList.clear();
        try{
            tmpList = (ArrayList<HashMap<String, String>>)Function.readCachedFile  (SMSMainActivity.this, "smsapp");
            tmpadapter = new InboxAdapter(SMSMainActivity.this, tmpList);
            listView.setAdapter(tmpadapter);
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                public void onItemClick(AdapterView<?> parent, View view,
                                        final int position, long id) {
                    loadsmsTask.cancel(true);
                    Intent intent = new Intent(SMSMainActivity.this, Chat.class);
    ...
    class LoadSms extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            // Updating cache data
            try{
                Function.createCachedFile (SMSMainActivity.this,"smsapp", smsList);
            }catch (Exception e) {}
            // Updating cache data
        ...
        protected void onPostExecute(String xml) {
            ...
            {
                adapter = new InboxAdapter(SMSMainActivity.this, smsList);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        switch (requestCode)
        {
            case REQUEST_PERMISSION_KEY: {
                ...
                {
                    Toast.makeText(SMSMainActivity.this, "You must accept permissions.", Toast.LENGTH_LONG).show();
                }
            }
        }
